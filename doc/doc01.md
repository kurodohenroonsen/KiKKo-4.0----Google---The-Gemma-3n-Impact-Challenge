...
We experience an **assisted digital amnesia**. We delegate our memory, and in return, we get algorithmic suggestions. We've lost the intimate connection to the story of our own knowledge.
...
Kikko uses game mechanics not to create addiction, but to establish an **intuitive language** between the Hive and its Forager. **Quests** are how the Hive expresses a need for knowledge. **Badges** and **Honey Points** are its forms of gratitude. Filling the **Honeycombs** is the visible act of building one's own cathedral of memories. The game is a metaphor that makes the process of structuring knowledge not only accessible, but joyful and desirable.
