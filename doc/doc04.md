...
*   **Function 2: The Hornet's Offer (WebView & AI Overview Integration):**
    ...
    *   He uses **ML Kit** to scrape and parse the "AI Overview" content (including its sources) from the WebView's HTML. He also prepares a quiz.
...
The AI Queen is the orchestrator, the true brain of the Hive. She uses a powerful Large Language Model (Gemma) to understand the *meaning* and *relationships* between data fragments.
...
*   **Function 2: Formulating Clarification & Contextual Dialogues:** For Léa, this is vital. If the OCR is uncertain about a word, the Queen will ask for confirmation: "Did that say 'Peanut' or 'Pecan'?". She also asks for human context: "Did you notice a 'may contain' warning on the packaging?".
