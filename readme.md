...
*   **Forge "Informative Honey":** Your on-device **AI Queen (Gemma)** and **Worker Bees (ML Kit)** process this pollen. Through a fun, interactive dialogue managed by the **Bourdon**, the Queen may issue new quests for missing details ("Forager, I need a clearer photo of the nutritional values!") or conduct her own web research to enrich the data, before forging structured, verifiable "Informative Honey."
...
*   **Battle in the "Arena":** The hexagonal patterns on your turtle's shell are your **decks of knowledge cards** (e.g., 'Plants', 'Foods', 'Insects'). Challenge friends nearby via Bluetooth to a "Saga Clash"! For each round, players agree on a deck to use. A card from the 'Foods' deck can only battle another 'Foods' card. **After 4 rounds, the winner gets more points, but both players get to keep all 8 cards played**, enriching everyone's saga.
...
*   **Dual Provenance & Inference Reproduction:** The "Thread of Provenance" is the ultimate rulebook.
    *   **Hive-Forged Stats:** Created through a **human-AI partnership** between you and your Hive. They are validated by you and their creation process is logged. Any other player's Hive can **reproduce the inference** to verify their authenticity. These are the strongest stats.
    *   **Hornet-Sourced Stats:** Information from external AIs, or from the Hive's own web research, is clearly tagged. Its "provenance" is the saved HTML source. It's traceable, but its creation is not reproducible, making it a "wild card" in battles.
