...
| **1.1 L'Écho Fugace :** Notre héros, Hiro, fait l'expérience de la frustration universelle d'un souvenir qui s'efface. | **1.2 Le Début d'une Saga :** Il reçoit son Gardien Kikkō personnel, le réceptacle de son futur savoir. | **1.3 L'Éveil de la Forge :** Sa Ruche IA personnelle et ses artisans proactifs s'éveillent, prêts à l'aider à nourrir son Gardien. |

---

### **2. Le Gameplay : Une Forge Vivante et Communautaire**

Le cœur du jeu est un cycle vertueux qui met en valeur notre architecture unique et évolutive : **Explorer -> Capturer -> Forger -> Nourrir -> Défier.**
...
| **2.1 La Quête :** La Ruche assigne une quête critique à Léa : butiner les ingrédients d'un biscuit pour produire du Miel. | **2.2 Nourrir & Grandir :** Son Gardien mange le "Miel Informatif" fraîchement forgé, assimilant le savoir et devenant plus fort. | **2.3 Le Choc des Sagas :** Dans l'Arène, le savoir des joueurs est mis à l'épreuve dans un combat de cartes amical et mutuellement bénéfique. |

---

### **3. L'Architecture Évolutive : Notre Avantage Compétitif**

Notre projet est une démonstration technique conçue pour impressionner, basée sur trois piliers d'innovation :

* **100% Embarqué & Privé :** Votre Ruche, votre Gardien, vos souvenirs — tout est sécurisé sur votre appareil.
* **Transparence Radicale & Confiance Vérifiable :** C'est notre innovation clé. Chaque carte forgée possède un **"Fil de Provenance"** (`provenance.json`), un journal qui enregistre tout : les modèles utilisés, les prompts exacts, les réponses brutes, et même les **décisions du Juge IA**. N'importe quelle autre Ruche peut utiliser ce journal pour **rejouer l'inférence** et vérifier l'authenticité de la carte. C'est la fin de l'IA "boîte noire".
* **Une IA Vivante et Personnalisable :** C'est notre vision pour le futur. Les **prompts** qui guident notre Reine IA et les **questions** de l'Arène ne sont pas gravés dans le code. Ils sont stockés dans des fichiers de configuration locaux. Cela ouvre deux possibilités révolutionnaires :
    1.  **La Forge des Prompts :** L'utilisateur peut **modifier lui-même les prompts** pour personnaliser la personnalité de sa Ruche ou la logique de son Juge.
    2.  **Le Nectar de la Ruche Mère :** L'application peut **télécharger des "packs de prompts" et des "sets de questions"** depuis notre serveur `kikko.be`. Nous pouvons ainsi améliorer l'intelligence et la créativité de toutes les Ruches en continu, sans jamais nécessiter une mise à jour de l'application via le store.
...
| **3.1 La Tentation :** Le Frelon offre une statistique rapide et non vérifiée, un "fast-food" pour votre Gardien. | **3.2 Provenance Transparente :** La carte qui en résulte distingue clairement les stats fiables et reproductibles de la Ruche de celles qui sont traçables mais moins fiables du Frelon. | **3.3 L'Arbitre Ultime :** La **Reproduction d'Inférence** agit comme le juge infaillible, assurant un jeu équitable et une confiance totale. |

---

### **4. Une Nouvelle Catégorie : Le Jeu de Connaissance Évolutif**

`Kikko's Saga Forge` est plus qu'un jeu. C'est un **"Jeu de Connaissance Vérifiable"** et un **"Tamagotchi Mémoriel"**. Le but n'est pas seulement de gagner, mais de construire le Gardien le plus savant, un reflet de votre propre saga. C'est un jeu où la curiosité et l'honnêteté sont les vrais super-pouvoirs, et où la récompense est un compagnon IA proactif en qui vous pouvez avoir une confiance absolue, car **vous l'avez forgé et vous pouvez le faire évoluer vous-même.**
...
| **4.1 La Saga Vivante :** Avec le temps, le Gardien Kikkō devient une extension puissante et magnifique du savoir personnel de l'utilisateur. | **4.2 L'Étincelle de Perspicacité :** Le savoir assimilé et fiable du Gardien permet à la Ruche de fournir une assistance pro-active et vitale. | **4.3 Le Soi Augmenté :** La véritable "victoire" du jeu est un compagnon qui vous comprend et vous protège, un témoignage de votre propre parcours de découverte. |